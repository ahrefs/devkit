...
fun cmp_1 ->
  fun k1_2 ->
    fun k2_3 ->
      fun e1_4 ->
        fun e2_5 ->
          let _found_6 = Stdlib.ref false in
          let rec next_7 () =
            ...
            | (None, Some y_10) ->
                (Enum.junk e2_5; Stdlib.raise Enum.No_more_elements)
            | (Some x_11, Some y_12) ->
...
fun cmp_16 ->
  fun k1_17 ->
    fun k2_18 ->
      fun e1_19 ->
        fun e2_20 ->
          let _found_21 = Stdlib.ref false in
          let rec next_22 () =
            ...
            | (None, Some y_25) ->
                (Enum.junk e2_20; Stdlib.raise Enum.No_more_elements)
            | (Some x_26, Some y_27) ->
...
fun cmp_31 ->
  fun k1_32 ->
    fun k2_33 ->
      fun e1_34 ->
        fun e2_35 ->
          let _found_36 = Stdlib.ref false in
          let rec next_37 () =
            ...
            | (Some x_41, Some y_42) ->
                ...
                (match cmp_31 k1_43 k2_44 with
                 ...
                 | _ -> (Enum.junk e2_35; (None, y_42))) in
          Enum.from next_37
...
fun cmp_46 ->
  fun k1_47 ->
    fun k2_48 ->
      fun e1_49 ->
        fun e2_50 ->
          let _found_51 = Stdlib.ref false in
          let rec next_52 () =
            ...
            | (Some x_56, Some y_57) ->
                ...
                (match cmp_46 k1_58 k2_59 with
                 ...
                 | _ -> (Enum.junk e2_50; `Right y_57)) in
          Enum.from next_52
...
fun cmp_61 ->
  fun k1_62 ->
    fun k2_63 ->
      fun e1_64 ->
        fun e2_65 ->
          let _found_66 = Stdlib.ref false in
          let rec next_67 () =
            ...
            | (None, Some y_70) ->
                (Enum.junk e2_65; Stdlib.raise Enum.No_more_elements)
            | (Some x_71, Some y_72) ->
...
fun cmp_76 ->
  fun k1_77 ->
    fun k2_78 ->
      fun e1_79 ->
        fun e2_80 ->
          let _found_81 = Stdlib.ref false in
          let rec next_82 () =
            let _prev_found_84 =
            ...
            | (Some x_85, None) ->
                (Enum.junk e1_79;
                 if Stdlib.not _prev_found_84
                 then (x_85, None)
                 else next_82 ())
            | (None, Some y_86) ->
                (Enum.junk e2_80; Stdlib.raise Enum.No_more_elements)
            | (Some x_87, Some y_88) ->
...
fun cmp_92 ->
  fun k1_93 ->
    fun k2_94 ->
      fun e1_95 ->
        fun e2_96 ->
          let _found_97 = Stdlib.ref false in
          let rec next_98 () =
            ...
            | (Some x_102, Some y_103) ->
                ...
                (match cmp_92 k1_104 k2_105 with
                 ...
                 | _ -> (Enum.junk e2_96; (None, y_103))) in
          Enum.from next_98
...
fun cmp_107 ->
  fun k1_108 ->
    fun k2_109 ->
      fun e1_110 ->
        fun e2_111 ->
          let _found_112 = Stdlib.ref false in
          let rec next_113 () =
            let _prev_found_115 =
              let prev_114 = ! _found_112 in _found_112 := false; prev_114 in
            match ((Enum.peek e1_110), (Enum.peek e2_111)) with
            | (None, None) -> Stdlib.raise Enum.No_more_elements
            | (Some x_116, None) ->
                (Enum.junk e1_110;
                 if Stdlib.not _prev_found_115
                 then `Left x_116
                 else next_113 ())
            ...
            | (Some x_118, Some y_119) ->
                ...
                (match cmp_107 k1_120 k2_121 with
                 ...
                 | _ -> (Enum.junk e2_111; `Right y_119)) in
          Enum.from next_113
...
fun cmp_123 ->
  fun e1_124 ->
    fun e2_125 ->
      let _found_126 = Stdlib.ref false in
      let rec next_127 () =
        ...
        | (None, Some y_130) ->
            (Enum.junk e2_125; Stdlib.raise Enum.No_more_elements)
        | (Some x_131, Some y_132) ->
            let k1_133 = Stdlib.fst x_131 in
            let k2_134 = Stdlib.fst y_132 in
            (match cmp_123 k1_133 k2_134 with
             ...
             | _ -> (Enum.junk e2_125; next_127 ())) in
      Enum.from next_127
...
fun cmp_136 ->
  fun e1_137 ->
    fun e2_138 ->
      let _found_139 = Stdlib.ref false in
      let rec next_140 () =
        let _prev_found_141 = false in
        match ((Enum.peek e1_137), (Enum.peek e2_138)) with
        | (None, None) -> Stdlib.raise Enum.No_more_elements
        | (Some x_142, None) ->
            (Enum.junk e1_137; ((Stdlib.fst x_142), (Stdlib.snd x_142), None))
        | (None, Some y_143) ->
            (Enum.junk e2_138; Stdlib.raise Enum.No_more_elements)
        | (Some x_144, Some y_145) ->
            let k1_146 = Stdlib.fst x_144 in
            let k2_147 = Stdlib.fst y_145 in
            (match cmp_136 k1_146 k2_147 with
             ...
             | n_148 when n_148 < 0 ->
                 (Enum.junk e1_137; (k1_146, (Stdlib.snd x_144), None))
             | _ -> (Enum.junk e2_138; next_140 ())) in
      Enum.from next_140
...
fun cmp_149 ->
  fun e1_150 ->
    fun e2_151 ->
      let _found_152 = Stdlib.ref false in
      let rec next_153 () =
        ...
        | (None, Some y_156) ->
            (Enum.junk e2_151; ((Stdlib.fst y_156), None, (Stdlib.snd y_156)))
        | (Some x_157, Some y_158) ->
            let k1_159 = Stdlib.fst x_157 in
            let k2_160 = Stdlib.fst y_158 in
            (match cmp_149 k1_159 k2_160 with
             ...
             | _ -> (Enum.junk e2_151; (k2_160, None, (Stdlib.snd y_158)))) in
      Enum.from next_153
...
fun cmp_162 ->
  fun e1_163 ->
    fun e2_164 ->
      let _found_165 = Stdlib.ref false in
      let rec next_166 () =
        ...
        | (Some x_170, Some y_171) ->
            let k1_172 = Stdlib.fst x_170 in
            let k2_173 = Stdlib.fst y_171 in
            (match cmp_162 k1_172 k2_173 with
             ...
             | n_174 when n_174 < 0 ->
                 (Enum.junk e1_163; (k1_172, (`Left (Stdlib.snd x_170))))
             | _ -> (Enum.junk e2_164; (k2_173, (`Right (Stdlib.snd y_171))))) in
      Enum.from next_166
...
fun cmp_175 ->
  fun e1_176 ->
    fun e2_177 ->
      let _found_178 = Stdlib.ref false in
      let rec next_179 () =
        ...
        | (None, Some y_182) ->
            (Enum.junk e2_177; Stdlib.raise Enum.No_more_elements)
        | (Some x_183, Some y_184) ->
            let k1_185 = Stdlib.fst x_183 in
            let k2_186 = Stdlib.fst y_184 in
            (match cmp_175 k1_185 k2_186 with
             ...
             | _ -> (Enum.junk e2_177; next_179 ())) in
      Enum.from next_179
...
fun cmp_188 ->
  fun e1_189 ->
    fun e2_190 ->
      let _found_191 = Stdlib.ref false in
      let rec next_192 () =
        let _prev_found_194 =
        ...
        | (Some x_195, None) ->
            (Enum.junk e1_189;
             if Stdlib.not _prev_found_194
             then ((Stdlib.fst x_195), (Stdlib.snd x_195), None)
             else next_192 ())
        | (None, Some y_196) ->
            (Enum.junk e2_190; Stdlib.raise Enum.No_more_elements)
        | (Some x_197, Some y_198) ->
            let k1_199 = Stdlib.fst x_197 in
            let k2_200 = Stdlib.fst y_198 in
            (match cmp_188 k1_199 k2_200 with
             ...
             | n_201 when n_201 < 0 ->
                 (Enum.junk e1_189;
                  if Stdlib.not _prev_found_194
                  then (k1_199, (Stdlib.snd x_197), None)
                  else next_192 ())
             | _ -> (Enum.junk e2_190; next_192 ())) in
      Enum.from next_192
...
fun cmp_202 ->
  fun e1_203 ->
    fun e2_204 ->
      let _found_205 = Stdlib.ref false in
      let rec next_206 () =
        ...
        | (None, Some y_209) ->
            (Enum.junk e2_204; ((Stdlib.fst y_209), None, (Stdlib.snd y_209)))
        | (Some x_210, Some y_211) ->
            let k1_212 = Stdlib.fst x_210 in
            let k2_213 = Stdlib.fst y_211 in
            (match cmp_202 k1_212 k2_213 with
             ...
             | _ -> (Enum.junk e2_204; (k2_213, None, (Stdlib.snd y_211)))) in
      Enum.from next_206
...
fun cmp_215 ->
  fun e1_216 ->
    fun e2_217 ->
      let _found_218 = Stdlib.ref false in
      let rec next_219 () =
        let _prev_found_221 =
        ...
        | (Some x_222, None) ->
            (Enum.junk e1_216;
             if Stdlib.not _prev_found_221
             then ((Stdlib.fst x_222), (`Left (Stdlib.snd x_222)))
             else next_219 ())
        | (None, Some y_223) ->
            (Enum.junk e2_217;
             ((Stdlib.fst y_223), (`Right (Stdlib.snd y_223))))
        | (Some x_224, Some y_225) ->
            let k1_226 = Stdlib.fst x_224 in
            let k2_227 = Stdlib.fst y_225 in
            (match cmp_215 k1_226 k2_227 with
             ...
             | n_228 when n_228 < 0 ->
                 (Enum.junk e1_216;
                  if Stdlib.not _prev_found_221
                  then (k1_226, (`Left (Stdlib.snd x_224)))
                  else next_219 ())
             | _ -> (Enum.junk e2_217; (k2_227, (`Right (Stdlib.snd y_225))))) in
      Enum.from next_219
...
fun cmp_229 ->
  fun e1_230 ->
    fun e2_231 ->
      let _found_232 = Stdlib.ref false in
      let rec next_233 () =
        ...
        | (Some x_237, Some y_238) ->
            ...
            (match cmp_229 k1_239 k2_240 with
             ...
             | _ -> (Enum.junk e2_231; (None, (Some y_238)))) in
      Enum.from next_233
...
fun cmp_242 ->
  fun e1_243 ->
    fun e2_244 ->
      let _found_245 = Stdlib.ref false in
      let rec next_246 () =
        ...
        | (Some x_250, Some y_251) ->
            let k1_252 = Stdlib.fst x_250 in
            let k2_253 = Stdlib.fst y_251 in
            (match cmp_242 k1_252 k2_253 with
             | 0 ->
                 (Enum.junk e1_243;
                  Enum.junk e2_244;
                  (k1_252, (Some (Stdlib.snd x_250)),
                    (Some (Stdlib.snd y_251))))
             | n_254 when n_254 < 0 ->
                 (Enum.junk e1_243; (k1_252, (Some (Stdlib.snd x_250)), None))
             | _ ->
                 (Enum.junk e2_244; (k2_253, None, (Some (Stdlib.snd y_251))))) in
      Enum.from next_246
