  ...
  fun e1_137 ->
    fun e2_138 ->
      ...
      let rec next_140 () =
        ...
        | (None, None) -> Pervasives.raise Enum.No_more_elements
        | (Some x_142, None) ->
            (Enum.junk e1_137; ((Pervasives.fst x_142), (Pervasives.snd x_142), None))
        | (None, Some y_143) ->
        ...
        | (Some x_144, Some y_145) ->
            ...
            (match cmp_136 k1_146 k2_147 with
             | 0 ->
                 (Enum.junk e1_137;
                  Enum.junk e2_138;
                  (k1_146, (Pervasives.snd x_144), (Some (Pervasives.snd y_145))))
             | n_148 when n_148 < 0 ->
  ...
  fun e1_150 ->
    fun e2_151 ->
      ...
      let rec next_153 () =
        ...
        | (None, Some y_156) ->
            (Enum.junk e2_151; ((Pervasives.fst y_156), None, (Pervasives.snd y_156)))
        | (Some x_157, Some y_158) ->
            ...
            (match cmp_149 k1_159 k2_160 with
             | 0 ->
                 (Enum.junk e1_150;
                  Enum.junk e2_151;
                  (k1_159, (Some (Pervasives.snd x_157)), (Pervasives.snd y_158)))
             | n_161 when n_161 < 0 -> (Enum.junk e1_150; next_153 ())
             | _ -> (Enum.junk e2_151; (k2_160, None, (Pervasives.snd y_158)))) in
      Enum.from next_153
        ...
        | (Some x_170, Some y_171) ->
            ...
            (match cmp_162 k1_172 k2_173 with
             | 0 ->
                 (Enum.junk e1_163;
                  Enum.junk e2_164;
                  (k1_172, (`Both ((Pervasives.snd x_170), (Pervasives.snd y_171)))))
             | n_174 when n_174 < 0 ->
                 (Enum.junk e1_163; (k1_172, (`Left (Pervasives.snd x_170))))
             | _ -> (Enum.junk e2_164; (k2_173, (`Right (Pervasives.snd y_171))))) in
      Enum.from next_166
        ...
        | (Some x_197, Some y_198) ->
            ...
            (match cmp_188 k1_199 k2_200 with
             | 0 ->
                 (_found_191 := true;
                  Enum.junk e2_190;
                  (k1_199, (Pervasives.snd x_197), (Some (Pervasives.snd y_198))))
             | n_201 when n_201 < 0 ->
                 (Enum.junk e1_189;
                  if Pervasives.not _prev_found_194
  ...
  fun e1_203 ->
    fun e2_204 ->
      ...
      let rec next_206 () =
        ...
        | (None, Some y_209) ->
            (Enum.junk e2_204; ((Pervasives.fst y_209), None, (Pervasives.snd y_209)))
        | (Some x_210, Some y_211) ->
            ...
            (match cmp_202 k1_212 k2_213 with
             | 0 ->
                 (();
                  Enum.junk e2_204;
                  (k1_212, (Some (Pervasives.snd x_210)), (Pervasives.snd y_211)))
             | n_214 when n_214 < 0 -> (Enum.junk e1_203; next_206 ())
             | _ -> (Enum.junk e2_204; (k2_213, None, (Pervasives.snd y_211)))) in
      Enum.from next_206
        ...
        | (Some x_224, Some y_225) ->
            ...
            (match cmp_215 k1_226 k2_227 with
             | 0 ->
                 (_found_218 := true;
                  Enum.junk e2_217;
                  (k1_226, (`Both ((Pervasives.snd x_224), (Pervasives.snd y_225)))))
             | n_228 when n_228 < 0 ->
                 (Enum.junk e1_216;
                  if Pervasives.not _prev_found_221
                  then (k1_226, (`Left (Pervasives.snd x_224)))
                  else next_219 ())
             | _ -> (Enum.junk e2_217; (k2_227, (`Right (Pervasives.snd y_225))))) in
      Enum.from next_219
      ...
      let rec next_246 () =
        ...
        | (Some x_250, Some y_251) ->
            ...
            (match cmp_242 k1_252 k2_253 with
             ...
             | n_254 when n_254 < 0 ->
                 (Enum.junk e1_243; (k1_252, (Some (Pervasives.snd x_250)), None))
             | _ ->
                 (Enum.junk e2_244; (k2_253, None, (Some (Pervasives.snd y_251))))) in
      Enum.from next_246
